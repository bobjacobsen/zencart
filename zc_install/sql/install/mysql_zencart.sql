...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Require Extra Field #1', 'EXTRAFIELD_REQUIRED1', 'false', 'Display extra Field #1 during account creation and with account information', '5', '6', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Require Extra Field #2', 'EXTRAFIELD_REQUIRED2', 'false', 'Display extra Field #2 during account creation and with account information', '5', '6', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Require Extra Field #3', 'EXTRAFIELD_REQUIRED3', 'false', 'Display extra Field #3 during account creation and with account information', '5', '6', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Require Extra Field #5', 'EXTRAFIELD_REQUIRED5', 'false', 'Display extra Field #5 during account creation and with account information', '5', '6', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
